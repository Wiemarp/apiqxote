...
namespace apiqxote.Migrations
{
    ...
    [Migration("20231123101840_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("apiqxote.Models.Animal", b =>
                {
                    ...
                    b.HasIndex(new[] { "ZoneZone" }, "fk_animal_zone1");
            ...
            modelBuilder.Entity("apiqxote.Models.TreeName", b =>
                {
                    ...
                    b.Property<string>("CoördinateCount")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(45)
                        .HasColumnType("varchar(45)")
            ...
            modelBuilder.Entity("apiqxote.Models.Animal", b =>
                {
                    b.HasOne("apiqxote.Models.Zone", "ZoneZoneNavigation")
                        .WithMany("Animals")
                        .HasForeignKey("ZoneZone")
                        .IsRequired()
                        .HasConstraintName("fk_animal_zone1");

                    b.Navigation("ZoneZoneNavigation");
                });
